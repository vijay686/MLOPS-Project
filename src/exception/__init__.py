...
def error_message_detail(error: Exception, error_detail: sys) -> str:
    ...
    # exc_info() gives 3 return values, but 2 useless two values are discarded with "_"
    _, _, exc_tb = error_detail.exc_info()

    # Get the file name where the exception occurred
    # tb_frame extracts the frame, .f_code gives the code of frame
    # .co_filename gives the file name where traceback error occured.
